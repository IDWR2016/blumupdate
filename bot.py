...
class BlumTod:
    ...
    def main(self):
        banner = f"""
{magenta}   _______ _       _____     ___             _       __  {putih}BlumTod Auto Claim for {hijau}blum
{magenta}  /  _/ _  | /| / /  _     / _  _______    (_)__ ____/ /_ {hijau}Author : {putih}AR
{magenta}_/ // // / |/ |/ /  , _/  / ___/ __/ _   / / -_) __/ __/ {putih}Github : {hijau}https://github.com/IDWR2016/
{magenta}/___/____/|__/|__/_/|_| /_/  /_/  ___/_/ /__/__/__/_ /    {hijau}Note : {putih}Segala Resiko Di tanggung
                                     |___/
        """
